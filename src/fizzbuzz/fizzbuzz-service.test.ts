...
describe('fizzbuzz service', () => {
    ...
    it('should return "Invalid Item" when input is A', () => {
        const input = ['A', 'B'];
        const actual = fizzBuzz(input);
        const expected = ['Invalid Item', 'Invalid Item'];
        expect(actual).toEqual(expected);
    });

    it('should return "Divided 23 by 3\nDivided 23 by 5" when input is 23', () => {
        const input = ['23'];
        const actual = fizzBuzz(input);
        const expected = ['Divided 23 by 3\nDivided 23 by 5'];
        expect(actual).toEqual(expected);
    });

    it('should return "Divided 23 by 3\nDivided 23 by 5" when input is 23', () => {
        const input = ['1', '3', '5', '', '15', 'A', '23'];
        const actual = fizzBuzz(input);
        const expected = ['Divided 1 by 3\nDivided 1 by 5', 'Fizz', 'Buzz', 'Invalid Item', 'FizzBuzz', 'Invalid Item', 'Divided 23 by 3\nDivided 23 by 5'];
        expect(actual).toEqual(expected);
    });
});